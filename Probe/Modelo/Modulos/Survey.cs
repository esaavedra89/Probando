...
namespace Probe.Modelo.Modulos
{
    public class Survey
    {
        ...
        [JsonProperty(PropertyName = "client_status_id")]
        public string IdEstadoCliente { get; set; }

        [JsonProperty(PropertyName = "client_status_name")]
